...
/*   Updated: 2022/05/02 11:12:58 by eavilov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_swap(int *a, int *b); // Swaps two elements
void			ft_putchar(int c); // prints a character
void			ft_putnbr(long int nb); // prints an int
